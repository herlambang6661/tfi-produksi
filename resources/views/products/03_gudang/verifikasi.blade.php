                                            ...
                                            <div class="row row-cards">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" name="qty" id="qty"
                                                        class="form-control" value="{{ $verifikasi->qty }}">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Package</label>
                                                    <input type="text" name="package" id="package"
                                                        class="form-control" value="{{ $verifikasi->package }}">
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="driver" id="driver"
                                                        class="form-select select2Driver" data-select2-id="driver"
                                                    ...
                                                    <script type="text/javascript">
                                                        $('#driver').change(function() {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                beforeSend: function() {
                                                                    $('#isiIdentitasDriver').html(
                                                                        'Loading Data. . .'
                                                                    )
                                                                },
                                                                success: function(response) {
                                                                    $('#isiIdentitasDriver').html(response);
                                                                },
                                                                error: function(data) {
                                                                    $('#isiIdentitasDriver').html(
                                                                        '-- ' + data + ' --'
