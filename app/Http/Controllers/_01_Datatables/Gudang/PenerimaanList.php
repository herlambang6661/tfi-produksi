        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('status', function ($row) {
                    // 0 = deleted, 1 = open, 2 = needed approval, 3 = signed, 4 = closed, 99 = processed result
                    if ($row->status == 0) {
                        return '
                            <span class="status status-dark status-lite border-dark shadow-sm">
                        ...
                        return '
                            <span class="status status-blue status-lite border-blue shadow-sm">
                                <span class="status-dot status-dot-animated"></span>
                                Open
                            </span>
                        ';
                        ...
                        return '
                            <span class="status status-red status-lite border-red shadow-sm">
                                <span class="status-dot status-dot-animated"></span>
                                Need Approval
                            </span>
                        ';
                        ...
                        return '
                            <span class="status status-green status-lite border-green shadow-sm">
                                <span class="status-dot status-dot-animated"></span>
                                Signed
                            </span>
                        ';
                        ...
                        return '
                            <span class="status status-yellow status-lite border-yellow shadow-sm">
                                <span class="status-dot status-dot-animated"></span>
                                Closed
                            </span>
                        ';
                        ...
                        return '
                            <span class="status status-orange status-lite border-orange shadow-sm">
                                <span class="status-dot status-dot-animated"></span>
                                Hasil Pengolahan
                            </span>
                        ';
