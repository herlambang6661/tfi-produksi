                ...
                ->addColumn('action', function ($row) {
                    ...
                    <button class="btn btn-sm btn-link align-text-top" data-bs-boundary="viewport" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" style="">
                                    <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-edit-warna" data-id="' . $row->id . '">
                                    ...
                                    <a href="#" class="dropdown-item remove" data-id="' . $row->id . '" data-nama="' . $row->warna . '" data-kode="' . $tipe->nama . '">
