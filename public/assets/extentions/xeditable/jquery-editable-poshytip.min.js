...
!(function (a) {
    ...
    (b.prototype = {
        ...
        (a.fn.editableform.buttons =
            '<button type="submit" class="editable-submit btn btn-primary">Simpan</button><button type="button" class="editable-cancel btn btn-info">Batal</button>'),
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.text),
            ...
            (b.defaults = a.extend({}, a.fn.editabletypes.text.defaults, {
                tpl: '<input type="password" class="form-control">',
            })),
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.text),
            (b.defaults = a.extend({}, a.fn.editabletypes.text.defaults, {
                tpl: '<input type="email" class="form-control">',
            })),
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.text),
            (b.defaults = a.extend({}, a.fn.editabletypes.text.defaults, {
                tpl: '<input type="url" class="form-control">',
            })),
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.text),
            (b.defaults = a.extend({}, a.fn.editabletypes.text.defaults, {
                tpl: '<input type="tel" class="form-control">',
            })),
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.number),
            ...
            (b.defaults = a.extend({}, a.fn.editabletypes.number.defaults, {
                tpl: '<input type="range" class="form-control"><output style="width: 30px; display: inline-block"></output>',
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
            ...
            (b.defaults = a.extend(
                {},
                a.fn.editabletypes.abstractinput.defaults,
                { tpl: '<input type="time" class="form-control">' }
            )),
    ...
    (function (a) {
        ...
        if (
                ...
                show: function (b) {
                    ...
                    var c = a("<label>").text(
                            this.options.title ||
                                ...
                                this.$element.data("originalTitle")
                        ),
            ...
            (a.fn.editableContainer.defaults = a.extend(
                {},
                a.fn.editableContainer.defaults,
            ...
            var b = /^url\(["']?([^"'\)]*)["']?\);?$/i,
                ...
                d =
                    !!window.createPopup &&
                    "undefined" ==
                        document.documentElement.currentStyle.minWidth;
                ...
                if (!this.disabled) {
                    ...
                    if (g) {
                        ...
                        d && i
                            ...
                            : this.$tip
                                  .prepend(
                                      '<table class="fallback" border="0" cellpadding="0" cellspacing="0"><tr><td class="tip-top tip-bg-image" colspan="2"><span></span></td><td class="tip-right tip-bg-image" rowspan="2"><span></span></td></tr><tr><td class="tip-left tip-bg-image" rowspan="2"><span></span></td><td></td></tr><tr><td class="tip-bottom tip-bg-image" colspan="2"><span></span></td></tr></table>'
                                  )
                                  .css({
                                      border: 0,
                                      padding: 0,
                    ...
                    if (
                        ...
                        h &&
                            ...
                            ((this.$arrow[0].className =
                                "tip-arrow tip-arrow-" + this.pos.arrow),
            ...
            a.extend(b.prototype, {
                initPicker: function (b, c) {
                    this.options.viewformat ||
                        (this.options.viewformat = this.options.format),
                        (this.options.viewformat =
                            this.options.viewformat.replace("yyyy", "yy")),
                        (this.options.format = this.options.format.replace(
                            "yyyy",
                            "yy"
                        )),
    ...
    (function (a) {
        "use strict";
        var b = function (a) {
            this.init("dateuifield", a, b.defaults),
                this.initPicker(a, b.defaults);
        };
        a.fn.editableutils.inherit(b, a.fn.editabletypes.dateui),
            a.extend(b.prototype, {
                render: function () {
                    this.$input.datepicker(this.options.datepicker),
                        a.fn.editabletypes.text.prototype.renderClear.call(
                            this
                        );
                },
                value2input: function (b) {
                    this.$input.val(
                        a.datepicker.formatDate(this.options.viewformat, b)
                    );
                },
                input2value: function () {
