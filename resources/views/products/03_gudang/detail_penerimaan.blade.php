                ...
                <div class="container-xl">
                    <form method="post" id="formVerifikasi" name="formVerifikasi" method="post"
                        ...
                        <div class="row row-deck row-cards">
                                            ...
                                            <div class="row row-cards">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" name="tanggal" id="tanggal" class="form-control"
                                                        value="{{ $verifikasi->tanggal }}" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Nopol</label>
                                                    <input type="text" class="form-control" name="nopol"
                                                        value="{{ $verifikasi->nopol }}" readonly>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label">NIK KTP</label>
                                                    <input type="text" class="form-control" name="ktp"
                                                        value="{{ $verifikasi->ktp }}" readonly>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label">Pengemudi</label>
                                                    <input type="text" class="form-control" name="driver"
                                                        value="{{ $verifikasi->driver }}" readonly>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label">Operator</label>
                                                    <input type="text" class="form-control" name="operator"
                                                        value="{{ $verifikasi->operator }}" readonly>
                                                </div>
                                                <div class="col-md-12">
                                                    <label class="form-label">Catatan</label>
                                                    <textarea name="keterangan" class="form-control" cols="3" rows="3" readonly>
                                                        ...
                                                        <tr class="trBarang_{{ $no }}">
                                                            ...
                                                            <td class="text-center">
                                                                <input type="number" min="1"
                                                                    ...
                                                                    class="form-control formBarang_{{ $no }}"
                                                                    value="{{ $data->kedatangan_ke }}" readonly>
                                                            </td>
                                                            <td class="text-center">
                                                                <input type="text" name="package[]" id="package"
                                                                    class="form-control" value="{{ $data->package }}"
                                                                    readonly>
                                                            </td>
                                                        </tr>
                                                @endforeach
                                                    ...
                                                    <div class="row row-cards">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <textarea id="signature64Operator" name="signedOperator" style="display: none" readonly></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <label class="form-label">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <textarea id="signature64Pengemudi" name="signedPengemudi" style="display: none" readonly></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-md-12">
                                <a href="{{ url('gudang/penerimaan') }}" class="btn btn-danger">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
