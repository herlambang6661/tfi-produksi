...
@section('content')
    ...
    <div class="page">
        ...
        <div class="page-wrapper">
            ...
            {{-- Modal Detail --}}
            <div class="modal modal-blur fade" id="modal-detail-penerimaan" tabindex="-1" role="dialog"
                aria-hidden="true">
                <div class="overlay">
                    <div class="cv-spinner">
                        <span class="loader"></span>
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="fecthed-detail-penerimaan"></div>
                    </div>
                </div>
            </div>
                ...
                $(function() {
                    ...
                    $('#modal-detail-penerimaan').on('show.bs.modal', function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                $('.fecthed-detail-penerimaan').html(data);
                            }
                        }).done(function() {
                            setTimeout(function() {
                                $(".overlay").fadeOut(300);
