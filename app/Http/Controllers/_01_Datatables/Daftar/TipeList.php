        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $btn = '
                            <a href="javascript:void(0);" class="btn btn-azure" data-bs-toggle="modal" data-bs-target="#modal-edit-tipe" data-id="' . $row->id . '">
                            ...
                            <a href="javascript:void(0);" class="btn btn-danger remove" data-id="' . $row->id . '" data-nama="' . $row->nama . '" data-kode="' . $row->kode . '">
