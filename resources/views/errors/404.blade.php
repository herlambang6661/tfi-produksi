...
<head>
    ...
    <title>404 PT Tantra Fiber Industry.</title>
    <!-- CSS files -->
...
<body class=" border-top-wide border-primary d-flex flex-column">
    ...
    <div class="page page-center">
        <div class="container-tight py-4">
            <div class="empty">
                <iframe src="https://lottie.host/embed/aaeaf097-b499-48ec-9e93-7fdf7cb2a3db/3TIUkh1TlI.json"
                    width="600px" height="300px"></iframe>
                <p class="empty-title">Oops… You just found an error page</p>
                <p class="empty-subtitle text-muted">
                    {{ !empty($message) ? $message : 'We are sorry but the page you are looking for was not found' }}
                </p>
                <div class="empty-action">
                    <button onclick="history.back()" class="btn btn-blue">
